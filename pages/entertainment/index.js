...
export default function index() {
    ...
    return (
    <div>
        <h2 style={ { textAlign: "center" } }>Entertainment News</h2>
...
async function getData(filter, apikey){
    let request = await fetch(`https://newsapi.org/v2/top-headlines?country=${filter}&category=entertainment&apiKey=${apikey}`);
